		...
		<div class="row">
			...
			<div class="col-md-10 pt-2">
				...
				<div class="container mt-4">
					...
					<form action="CreateCampaignController" method="post"
						onsubmit="return validateForm()">
						<div class="form-group">
							<label for="owner">Owner:</label> <input type="text"
								class="form-control" id="owner" name="owner" required>
						</div>
						<div class="form-group">
							<label for="phone">Phone Number:</label> <input type="tel"
								class="form-control" id="phone" name="phone" pattern="[0-9]{10}"
								required> <small class="form-text text-muted">Phone
						...
						<div class="form-group">
							<label for="bankAccount">Bank Account:</label> <input
								...
								name="bankAccount" pattern="[0-9]+" required> <small
						...
						<div class="form-group">
							...
							<small id="endDateError" class="form-text text-danger d-none">End
						...
						<div class="form-group">
							<label for="currentAmount">Current Amount:</label> <input
								...
								id="currentAmount" name="currentAmount" required> <small
